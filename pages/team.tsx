        ...
        <section className="py-20 bg-blueGray-50">
          <div className="container">
            <div className="max-w-lg mx-auto mb-12 text-center">
              ...
              >
                Meet Your{" "}
                <span className="text-blue-500">Experts</span> <br />
                Team Member
              </h2>
              <p
              ...
              <div className="w-full md:w-1/2 py-5 md:px-5">
                ...
                >
                  ...
                  <p className="leading-loose text-blueGray-400 mb-5">
                    Donec consequat tortor risus, at auctor felis
                    consequat a. Donec quis dolor sem. Sed
                    sollicitudin magna in hendrerit pulvinar.
        ...
        <section className="pt-20">
          <div className="container text-center">
            <div className="max-w-lg mx-auto mb-12">
              ...
              >
                Our Awesome <br />
                <span className="text-blue-500">Creative</span> Team
                Member
              </h2>
              <p
                className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn animated"
